...
def get_index_of_min_0_counts(string_lists):
    dict_of_counts_0 = {}
    ...
    return min_counts_of_0_index


def get_solution_1():
    string_lists = split_list(get_original_string(), 25 * 6)
    min_counts_of_0_index = get_index_of_min_0_counts(string_lists)
