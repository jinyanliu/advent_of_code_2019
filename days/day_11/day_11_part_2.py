...
def plot_message(dict_of_paint_on_location):
    list_of_message_panel = []
    for key in dict_of_paint_on_location.keys():
        if dict_of_paint_on_location[key] == Color.WHITE.value:
...
def get_solution_2():
    return get_unique_painted_locations_count([Color.WHITE.value], get_dict_of_int_input())
