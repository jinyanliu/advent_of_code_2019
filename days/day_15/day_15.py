...
def get_input(current_location, dict_of_paint_on_location, current_direction):
    current_x, current_y = current_location
...
# def should_go_to_right(dict_of_paint_on_location, current_x, current_y):
#     if ((current_x, current_y + 1) in dict_of_paint_on_location.keys()
#             or (current_x + 1, current_y + 1) in dict_of_paint_on_location.keys()
#             or (current_x + 2, current_y) in dict_of_paint_on_location.keys()
#             or (current_x + 1, current_y - 1) in dict_of_paint_on_location.keys()):
#         if (dict_of_paint_on_location[(current_x, current_y + 1)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 1, current_y + 1)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 2, current_y)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 1, current_y - 1)] == "wall"):
#             return False
#     if ((current_x, current_y + 1) in dict_of_paint_on_location.keys()
#             or (current_x + 1, current_y + 1) in dict_of_paint_on_location.keys()
#             or (current_x + 2, current_y + 1) in dict_of_paint_on_location.keys()
#             or (current_x + 3, current_y) in dict_of_paint_on_location.keys()
#             or (current_x + 2, current_y - 1) in dict_of_paint_on_location.keys()
#             or (current_x + 1, current_y - 1) in dict_of_paint_on_location.keys()):
#         if (dict_of_paint_on_location[(current_x, current_y + 1)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 1, current_y + 1)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 2, current_y + 1)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 3, current_y)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 2, current_y - 1)] == "wall"
#                 and dict_of_paint_on_location[(current_x + 1, current_y - 1)] == "wall"):
#             return False
#
...
#
#     if(current_direction == Direction.UP.value):
#         if (up_location not in dict_of_paint_on_location.keys()) or (not dict_of_paint_on_location[up_location] == "wall"):
#             return Direction.UP.value
#         if (right_location not in dict_of_paint_on_location.keys()) or (not dict_of_paint_on_location[right_location] == "wall"):
#             return Direction.RIGHT.value
#         if (down_location not in dict_of_paint_on_location.keys()) or (not dict_of_paint_on_location[down_location] == "wall"):
#             return Direction.DOWN.value
#         if (left_location not in dict_of_paint_on_location.keys()) or (not dict_of_paint_on_location[left_location] == "wall"):
#             return Direction.LEFT.value
#
#     if (current_direction == Direction.RIGHT.value):
#         if (right_location not in dict_of_paint_on_location.keys()) or (not dict_of_paint_on_location[right_location] == "wall"):
#             return Direction.RIGHT.value
#         if (up_location not in dict_of_paint_on_location.keys()) or (
#         not dict_of_paint_on_location[up_location] == "wall"):
#             return Direction.UP.value
#         if (right_location not in dict_of_paint_on_location.keys()) or (
#         not dict_of_paint_on_location[right_location] == "wall"):
#             return Direction.RIGHT.value
#         if (down_location not in dict_of_paint_on_location.keys()) or (
#         not dict_of_paint_on_location[down_location] == "wall"):
#             return Direction.DOWN.value
#         if (left_location not in dict_of_paint_on_location.keys()) or (
#         not dict_of_paint_on_location[left_location] == "wall"):
#             return Direction.LEFT.value
#
#
#     if (current_direction == Direction.DOWN.value):
#         if (down_location not in dict_of_paint_on_location.keys()) or (not dict_of_paint_on_location[down_location] == "wall"):
#             return Direction.DOWN.value
#         if (up_location not in dict_of_paint_on_location.keys()) or (
#         not dict_of_paint_on_location[up_location] == "wall"):
...
def get_unique_painted_locations_count(list_of_input_int, input_dict):
    i = 0
    step = 0
    relative_base = 0
    current_direction = 0
    ...
    while i + 1 < len(input_dict):
        ...
        if opcode == Opcode.ADD.value:
            ...
            count_of_input += 1
            input_value = get_input(current_location, dict_of_paint_on_location, current_direction)

            current_direction = input_value

            # if len(list_of_input_int) > 0:
            #     input_value = list_of_input_int[0]
            #     list_of_input_int.pop(0)
            # elif current_location in dict_of_paint_on_location.keys():
            ...
            if input_value == 1:
                print("input_value = up")
            if input_value == 2:
                print("input_value = down")
            if input_value == 3:
                print("input_value = left")
            if input_value == 4:
                print("input_value = right")
